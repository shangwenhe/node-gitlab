(function() {
  ...
  Projects = (function(superClass) {
    ...
    Projects.prototype.fork = function(params, fn) {
      ...
      return this.post("projects/" + params.id + "/fork", params, function(data) {
        if (fn) {
          return fn(data);
        }
      });
    ...
    Projects.prototype.listForks = function(params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Projects::listForks()");
      return this.get("projects/" + params.id + "/forks", (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
